...
public class InternalEntity extends EmployeeEntity {
  public InternalEntity() {
  }

  public InternalEntity(String name, String email, float basicSalary, LocalDate entryDate) {
    super(name, email, basicSalary, entryDate);
  }

  @Override
  public float calculateSalary() {
    final float INCREMENT_PERCENTAGE = 10;
